// TODO Refactorizar la base de datos llamada discord para concordancia con las mediciones y añadir extras
    ...
    FOREIGN KEY (cuenta) REFERENCES cuenta(dni)ON UPDATE CASCADE ON DELETE RESTRICT);
